...
## Knowledge Base
- Source 1: The "Databases for GenAI" presentation PDF, available in ./resources folder.
- Source 2: The video recordings of the corresponding lecture, available in ./resources folder.
...
- Load and Process Data:
  ...
  - prefere local AI model deployment via LM Studio
